...
def test():
    ...
    sp.add_compilation_target("schemaRegistry", SchemaRegistry(sp.address('KT1CiaJUoi7GZfZ8tWgpmJJ683QutdUfM9Yf'), sp.address('tz1PvnsRQsdhfEUFdFg6Z4CQpeDhWbXEDswm')))